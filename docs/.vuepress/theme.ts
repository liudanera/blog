...
export default hopeTheme({
    // 页面配置
    logo: "https://wang-b.oss-cn-nanjing.aliyuncs.com/20230314162821943f3181931d8285454a5e6f955f90333cb_1.jpg", // 导航栏左侧logo
    ...
    // 博主信息配置
    blog: {
        avatar: "https://wang-b.oss-cn-nanjing.aliyuncs.com/20230314162821943f3181931d8285454a5e6f955f90333cb_1.jpg",
        name: "刘蛋儿",
        description: "一个严重拖延症患者",
        medias: {
            GitHub: "https://github.com/liudanera",
            // MrHope: [
            //     "https://mrhope.site",
    ...
    // 编辑此页配置
    repo: "https://github.com/liudanera",
    docsBranch: "main",
    docsDir: "docs",
    metaLocales: {
        editLink: "编辑此页",
    ...
    plugins: {
        ...
        comment: {
            ...
            repoId: "R_kgDOJJXHoA",
            category: "General",
            categoryId: "DIC_kwDOJJXHoM4CU4Xy",
